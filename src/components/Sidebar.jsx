        ...
        <nav className="px-4 py-4 mt-5 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              {/* <!-- Menu Item Dashboard --> */}
              <SidebarLinkGroup
                activeCondition={pathname.startsWith("/dashboard")}
              >
                {(handleClick) => {
                  return (
                    <React.Fragment>
              ...
              <button
                ...
                className="flex items-center gap-3.5 py-3 px-3 text-sm font-medium duration-300 ease-in-out hover:text-danger lg:text-white"
              >
                <svg
                  className="fill-current"
                  width="22"
